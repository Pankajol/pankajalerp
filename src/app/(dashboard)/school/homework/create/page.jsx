...
export default function CreateHomework() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const headers = { headers: { Authorization: `Bearer ${token}` } };
      await api.post("/school/homework", formData, headers);
    ...
    <div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800">Create Homework</h2>
            <p className="text-sm text-gray-500">Assign homework to a class</p>
          </div>
        </div>
        ...
        <form>
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1 flex items-center gap-1">
                <FaCalendarAlt size={14} /> Due Date <span className="text-red-500">*</span>
              </label>
              <input
                type="date"
                name="dueDate"
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1 flex items-center gap-1">
                <FaAlignLeft size={14} /> Description
              </label>
              <textarea
                name="description"
          ...
          <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
            ...
            >
              <FaSave /> {saving ? "Creating..." : "Create Homework"}
            </button>
          </div>
        </form>
      </motion.div>
