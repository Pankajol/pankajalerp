    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <StatCard
          ...
          color="blue"
          onClick={() => router.push("/construction/boq")}
        />
        <StatCard
          icon={FaUsers}
          label="Labours"
          ...
          color="emerald"
          onClick={() => router.push("/construction/labour")}
        />
        <StatCard
          icon={FaUserFriends}
          ...
          color="amber"
          onClick={() => router.push("/construction/attendance")}
        />
        <StatCard
          ...
          color="rose"
          onClick={() => router.push("/construction/progress-billing")}
        />
        <StatCard
          ...
          color="purple"
          onClick={() => router.push("/construction/work-assignment")}
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Project Status Pie */}
        <ChartCard title="Project Status" onClick={() => router.push("/construction/projects")}>
          <Pie
            data={pieData}
            options={{
        ...
        {/* Attendance Pie */}
        <ChartCard title="Today's Attendance" onClick={() => router.push("/construction/attendance")}>
          <Pie
            data={attendanceData}
            options={{
              plugins: { legend: { position: "bottom", labels: { font: { size: 10 } } } },
        ...
        {/* Work Status Pie */}
        <ChartCard title="Work Assignment Status" onClick={() => router.push("/construction/work-assignment")}>
          <Pie
            data={workStatusData}
            options={{
              plugins: { legend: { position: "bottom", labels: { font: { size: 10 } } } },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <ActivityCard
          ...
          icon={FaBuilding}
          onClick={() => router.push("/construction/projects")}
          viewAllLink="/construction/projects"
        >
            ...
            <ul className="divide-y divide-gray-100">
              {recentProjects.map((project) => (
                <li
                  ...
                  onClick={() => router.push(`/construction/projects/${project._id}`)}
                >
        ...
        <ActivityCard
          ...
          icon={FaMoneyBillWave}
          onClick={() => router.push("/construction/progress-billing")}
          viewAllLink="/construction/progress-billing"
        >
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <button
            onClick={() => router.push("/dashboard/construction/work-assignment")}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {upcomingTasks.map((task) => (
                <div
                  ...
                  onClick={() => router.push(`/dashboard/construction/work-assignment/${task._id}`)}
                >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
        <QuickAction
          ...
          icon={FaPlus}
          color="indigo"
          onClick={() => router.push("/dashboard/construction/projects")}
        />
        <QuickAction
          label="New BOQ"
          icon={FaFileInvoice}
          color="blue"
          onClick={() => router.push("/dashboard/construction/boq")}
        />
        <QuickAction
          label="Add Labour"
          icon={FaUserFriends}
          color="emerald"
          onClick={() => router.push("/dashboard/construction/labour")}
        />
        <QuickAction
          label="Mark Attendance"
          icon={FaCalendarAlt}
          color="amber"
          onClick={() => router.push("/dashboard/construction/attendance")}
        />
        <QuickAction
          label="New Invoice"
          icon={FaMoneyBillWave}
          color="rose"
          onClick={() => router.push("/dashboard/construction/progress-billing")}
        />
        <QuickAction
          label="Daily Report"
          icon={FaClipboardList}
          color="purple"
          onClick={() => router.push("/dashboard/construction/daily-report")}
        />
      </div>
    </div>
  );
