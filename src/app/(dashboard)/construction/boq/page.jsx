            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  ...
                  <th className="px-6 py-4 text-left text-[10.5px] font-bold uppercase tracking-wider text-gray-400">Customer</th> {/* ✅ NEW */}
              ...
              <tbody className="divide-y divide-gray-50">
                {loading ? (
                  <tr>
                    <td colSpan="9" className="px-6 py-10 text-center text-gray-400 italic">Loading BOQs...</td>
                  </tr>
                ) : boqs.length === 0 ? (
                  <tr>
                    <td colSpan="9" className="px-6 py-10 text-center text-gray-400 italic">No BOQs found. Import from Excel or create manually.</td>
                  </tr>
                ) : (
                  boqs.map((b) => (
                    <tr key={b._id} className="hover:bg-indigo-50/20 transition-colors">
                      <td className="px-6 py-4">
                        <button
                          onClick={() => router.push(`/construction/boq/${b._id}`)}
...
//         const [boqRes, projRes, supRes] = await Promise.allSettled([
//           api.get("/construction/boq", headers),
//           api.get("/construction/projects", headers),
//           api.get("/suppliers", headers),
//         ]);
...
//               section: sec.name,
//               subSection: sub.name,
//               // ✅ sub.id is a number (generateId returns an integer)
//               subSectionIndex: sub.id,
//             });
//           }
//         });
...
//                 {loading ? (
//                   <tr>
//                     <td colSpan="7" className="px-6 py-10 text-center text-gray-400 italic">Loading BOQs...</td>
//                   </tr>
//                 ) : boqs.length === 0 ? (
//                   <tr>
//                     <td colSpan="7" className="px-6 py-10 text-center text-gray-400 italic">No BOQs found. Import from Excel or create manually.</td>
//                   </tr>
//                 ) : (
//                   boqs.map((b) => (
//                     <tr key={b._id} className="hover:bg-indigo-50/20 transition-colors">
