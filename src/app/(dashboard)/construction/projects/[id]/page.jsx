    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            onClick={() => router.push(`/construction/boq?projectId=${id}`)}
          ...
          <button
            onClick={() => router.push(`/construction/work-orders?projectId=${id}`)}
            className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-all text-left"
          >
          ...
          <button
            onClick={() => router.push(`/construction/material-consumption?projectId=${id}`)}
            className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-all text-left"
          >
