      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              onClick={() => router.push(`/construction/tenders/${id}/edit`)}
        ...
        {activeTab === "bids" && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              {tender.status === "published" && (
                <button
                  onClick={() => router.push(`/construction/tenders/${id}/bids/new`)}
                    ...
                    {bids.map((b) => (
                      <tr key={b._id} className="border-b border-gray-100">
                        ...
                        <td className="px-4 py-2 text-center">
                          <button
                            onClick={() =>
                              router.push(`/construction/tenders/${id}/bids/${b._id}`)
                            }
                    ...
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button
                            onClick={() =>
                              router.push(`/construction/tenders/${id}/evaluate/${b._id}`)
                            }
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            {tender.status === "awarded" ? (
              <div className="p-4 bg-emerald-50 rounded-xl text-emerald-700 font-bold">
                ...
                <button
                  onClick={() => router.push(`/construction/work-orders`)}
